...
void MT9V113MIPI_Init_Para(void)
{
	...
	MT9V113MIPIWBcount = AWB_MODE_AUTO;
	spin_unlock(&mt9v113mipi_drv_lock);
}
	...
	switch (para)
	 {
        ...
        {
			 MT9V113MIPI_write_cmos_sensor(0x98C, 0x2759);
			 MT9V113MIPI_write_cmos_sensor(0x990, 0x6444);
			 MT9V113MIPI_write_cmos_sensor(0x98C, 0x275B);
			 MT9V113MIPI_write_cmos_sensor(0x990, 0x6444);
			 MT9V113MIPI_write_cmos_sensor(0x98C, 0xA103);
			 MT9V113MIPI_write_cmos_sensor(0x990, 0x05); 
...
void MT9V113_MIPIGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{	
...
void MT9V113_MIPIGetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB("MT9V113_MIPIGetAFMaxNumMeteringAreas,*pFeatureReturnPara32 = %d\n",*pFeatureReturnPara32);

}

void MT9V113_MIPIGetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = MT9V113MIPIWBcount;
    pExifInfo->CapExposureTime = 0;
    pExifInfo->FlashLightTimeus = 0;
    pExifInfo->RealISOValue = AE_ISO_100;
}

void MT9V113_MIPIGetDelayInfo(UINT32 delayAddr)
{
...
UINT32 MT9V113MIPISetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) {
	kal_uint32 pclk;
	kal_int16 dummyLine;
	kal_uint16 lineLength,frameHeight;
		
	SENSORDB("MT9V113MIPISetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
...
UINT32 MT9V113MIPIGetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate) 
{
...
void MT9V113_MIPIGetAEAWBLock(UINT32 *pAElockRet32,UINT32 *pAWBlockRet32)
{
    *pAElockRet32 = 1;
	*pAWBlockRet32 = 1;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		//20130221 add this APIs
		case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
			MT9V113_MIPIGetAFMaxNumFocusAreas(pFeatureReturnPara32); 		   
			*pFeatureParaLen=4;
			break;
		case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
			MT9V113_MIPIGetAFMaxNumMeteringAreas(pFeatureReturnPara32);			  
			*pFeatureParaLen=4;
			break;
		case SENSOR_FEATURE_GET_EXIF_INFO:
			SENSORDB("SENSOR_FEATURE_GET_EXIF_INFO\n");
			SENSORDB("EXIF addr = 0x%x\n",*pFeatureData32); 		 
			MT9V113_MIPIGetExifInfo(*pFeatureData32);
			break;
		case SENSOR_FEATURE_GET_DELAY_INFO:
			SENSORDB("SENSOR_FEATURE_GET_DELAY_INFO\n");
		    MT9V113_MIPIGetDelayInfo(*pFeatureData32);
			break;
		case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
			MT9V113MIPISetMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, *(pFeatureData32+1));
			break;
		case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
			MT9V113MIPIGetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
			break;
		case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
			MT9V113_MIPIGetAEAWBLock((*pFeatureData32),*(pFeatureData32+1));
			break;
		default:
			 break;			
	}
