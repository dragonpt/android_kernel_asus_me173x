...
static void OV5648MIPI_Sensor_Init(void)
{
    ...
    */
    ...
    OV5648MIPI_write_cmos_sensor(0x4800, 0x14); // Send line short packet for each line.
...
static void OV5648MIPI_Preview_Setting(void)
{
    ...
    OV5648MIPI_write_cmos_sensor(0x3820, 0x1e); // flip off, v bin off
    OV5648MIPI_write_cmos_sensor(0x3821, 0x01); // mirror on, h bin on
...
static void OV5648MIPI_Capture_Setting(void)
{
    ...
    OV5648MIPI_write_cmos_sensor(0x3820, 0x56); // flip off, v bin off
    OV5648MIPI_write_cmos_sensor(0x3821, 0x00); // mirror on, v bin off
...
UINT32 OV5648MIPISetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) {
	...
	SENSORDB("OV5648MIPISetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
	switch (scenarioId) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			pclk = OV5648MIPI_PREVIEW_CLK;
