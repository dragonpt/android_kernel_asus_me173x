...
extern LCM_DRIVER cm_hx8896a01_dsi_vdo_lcm_drv;
extern LCM_DRIVER tm081jdh02_lcm_drv;
extern LCM_DRIVER n070lge_l41_lcm_drv;
extern LCM_DRIVER n101icgl21_lcm_drv;
...
#if defined(TM081JDH02)
	&tm081jdh02_lcm_drv,
#endif

#if defined(N070LGE_L41)
	&n070lge_l41_lcm_drv,
#endif

#if defined(N101ICGL21)
	&n101icgl21_lcm_drv,
#endif
