...
/* SENSOR 2M SIZE */
#define IMX111MIPI_IMAGE_SENSOR_PV_WIDTH		(IMX111MIPI_REAL_PV_WIDTH  + 2 * IMX111MIPI_IMAGE_SENSOR_PV_STARTX)	//
#define IMX111MIPI_IMAGE_SENSOR_PV_HEIGHT		(IMX111MIPI_REAL_PV_HEIGHT + 2 * IMX111MIPI_IMAGE_SENSOR_PV_STARTY)	//
/* SENSOR 8M SIZE */
#define IMX111MIPI_IMAGE_SENSOR_FULL_WIDTH		(IMX111MIPI_REAL_CAP_WIDTH  + 2 * IMX111MIPI_IMAGE_SENSOR_CAP_STARTX)	// 
#define IMX111MIPI_IMAGE_SENSOR_FULL_HEIGHT		(IMX111MIPI_REAL_CAP_HEIGHT + 2 * IMX111MIPI_IMAGE_SENSOR_CAP_STARTY)	//

#define IMX111MIPI_IMAGE_SENSOR_VIDEO_WIDTH		(IMX111MIPI_REAL_VIDEO_WIDTH  + 2 * IMX111MIPI_IMAGE_SENSOR_VIDEO_STARTX)	// 
#define IMX111MIPI_IMAGE_SENSOR_VIDEO_HEIGHT	(IMX111MIPI_REAL_VIDEO_HEIGHT + 2 * IMX111MIPI_IMAGE_SENSOR_VIDEO_STARTY)	// 

/* SENSOR PIXEL/LINE NUMBERS IN ONE PERIOD */
#define IMX111MIPI_PV_PERIOD_PIXEL_NUMS			IMX111MIPI_IMAGE_SENSOR_PV_WIDTH	// pixels
#define IMX111MIPI_PV_PERIOD_LINE_NUMS			IMX111MIPI_IMAGE_SENSOR_PV_HEIGHT	//
#define IMX111MIPI_FULL_PERIOD_PIXEL_NUMS		IMX111MIPI_IMAGE_SENSOR_FULL_WIDTH	//
#define IMX111MIPI_FULL_PERIOD_LINE_NUMS		IMX111MIPI_IMAGE_SENSOR_FULL_HEIGHT	//
#define IMX111MIPI_VIDEO_PERIOD_PIXEL_NUMS		IMX111MIPI_IMAGE_SENSOR_VIDEO_WIDTH	//
#define IMX111MIPI_VIDEO_PERIOD_LINE_NUMS		IMX111MIPI_IMAGE_SENSOR_VIDEO_HEIGHT	//
