...
ifeq ($(strip $(DOLBY_DAP)), yes)

PRODUCT_COPY_FILES += $(LOCAL_PATH)/audio_effects.conf:system/etc/audio_effects.conf

PRODUCT_COPY_FILES += $(LOCAL_PATH)/ds1-default.xml:data/dolby/ds1-default.xml
#[Aaron|2013.8.3] backup dolby files
PRODUCT_COPY_FILES += $(LOCAL_PATH)/ds1-default.xml:system/etc/ds1-default.xml
